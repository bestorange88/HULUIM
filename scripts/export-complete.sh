...
# 完整数据导出脚本
# 直接执行此脚本将创建 complete_export.sql 文件

cat > complete_export.sql << 'SQLEOF'
...
('f624656c-9611-4573-8966-73900acb4d52', 'usdt_exchange_rate', '', 'text', 'USDT兑换人民币汇率', NOW()),
...
-- 完成
SELECT '基础数据导入完成' as status;
SQLEOF

echo "基础配置已生成到 complete_export.sql"
echo ""
echo "用户数据需要分批导入，请继续执行下面的步骤"
